...
if (data.success) {
  ...
  return (
    ...
    <AdminPageShell
      title="Overview"
      description="Business analytics and user account management."
      actions={
        <Button variant="ghost" size="sm" className="rounded-xl text-xs font-semibold text-neutral-400 hover:text-white" onClick={handleLogout}>
          <LogOut className="mr-1.5 h-4 w-4" /> Logout ({admin?.username})
        </Button>
      }
    >
        {/* Overview Cards */}
